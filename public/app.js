...
$('#done-report-date').value=new Date().toISOString().slice(0,10);$('#done-report-print').onclick=()=>reportFile('-print');$('#done-report-xlsx').onclick=()=>openSowExport({base:'/api/done-sow-injections',token,start:$('#done-report-date').value});
